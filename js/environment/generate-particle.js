...
var generateParticle = function (sphericalCoords,start) {
  ...
  var x1 = Math.cos(phi+start) * Math.sin(eta/2)
  var x2 = Math.sin(phi+start) * Math.sin(eta/2)
  var x3 = Math.cos(phi+start) * Math.cos(eta/2)
  var x4 = Math.sin(phi+start) * Math.cos(eta/2)
